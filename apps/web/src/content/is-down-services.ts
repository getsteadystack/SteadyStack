...
export const SERVICES_DATA: ServiceDownInfo[] = [
...

  {
    ...
    description:
      "Google's flagship multimodal AI models including Gemini 1.5 Pro, Flash, and Gemini Live.",
    impactSummary:
      "Gemini API calls fail, multimodal prompts timeout, and Gemini web app displays 500/503 errors.",
    keyComponents: [
      "Gemini 1.5 Pro API",
      "Gemini 1.5 Flash",
      "Google AI Studio",
    ...
    troubleshootingSteps: [
      "Check Google Cloud Status Dashboard for Vertex AI & Generative Language incidents.",
      "Switch to fallback model providers (Anthropic Claude, OpenAI GPT-4o).",
      "Verify API quota and billing in Google AI Studio / Google Cloud Console.",
      "Implement exponential backoff on 429 quota exhaustion errors.",
    ],
  ...
  },
  {
    ...
    description:
      "AI-powered in-browser fullstack web application builder powered by WebContainers.",
    impactSummary:
      "Code generation stalls, WebContainers fail to boot, package installations hang, and previews crash.",
    keyComponents: [
      "AI Code Engine",
    ...
    troubleshootingSteps: [
      "Check StackBlitz status page for WebContainer and cloud service outages.",
      "Clear browser cache and reload the sandbox session.",
      "Export project code to local environment or GitHub repository.",
      "Inspect browser console for WebAssembly or WebSocket connection errors.",
    ],
  ...
  },
  {
    ...
    description:
      "Full-stack AI software engineer platform creating production-ready web apps from natural language.",
    impactSummary:
      "Prompt iterations fail, GitHub sync drops, sandbox previews fail to load, and Supabase integrations drop.",
    keyComponents: [
      "AI Prompt Engine",
      "Preview Environment",
      "GitHub Auto-Sync",
    ...
    troubleshootingSteps: [
      "Check Lovable system status and discord announcements.",
      "Verify GitHub token authorization and repository permissions.",
      "Test Supabase backend connection independently.",
      "Export project files or push latest commit via Git.",
    ],
  ...
  },
  {
    ...
    description:
      "Agentic IDE and AI developer assistant combining Cascade flow reasoning and multi-file code editing.",
    impactSummary:
      "Cascade AI agent stops responding, inline completions drop, and codebase indexing times out.",
    keyComponents: [
      "Cascade Flow Engine",
      "Supercomplete API",
      "Codebase Indexing Service",
      "Auth & Licensing Gateway",
    ],
    commonErrorCodes: [
      "503 Service Unavailable",
    ...
    troubleshootingSteps: [
      "Check Codeium status page for server and LLM infrastructure outages.",
      "Restart Windsurf IDE and re-authenticate your Codeium profile.",
      "Check local network proxy and firewall settings for WebSocket filtering.",
      "Switch to fallback AI copilot or local LLM provider.",
    ],
  ...
  },
  {
    ...
    description:
      "Generative AI platform specializing in video generation, Gen-2, Gen-3 Alpha, and creative tools.",
    impactSummary:
      "Video generation queues freeze, render tasks fail at 99%, API webhook callbacks drop, and asset exports fail.",
    keyComponents: [
      "Gen-3 Alpha Pipeline",
      "Video Inpainting API",
      "Asset Storage CDN",
      "Render Worker Fleet",
    ],
    commonErrorCodes: [
    ...
    troubleshootingSteps: [
      "Check Runway status page for GPU cluster backlog notices.",
      "Cancel stalled rendering tasks and re-submit with lower resolution.",
      "Verify credit balance and plan subscription status.",
      "Check browser GPU acceleration flags and WebGL compatibility.",
    ],
  ...
  },
  {
    ...
    description:
      "AI video generation foundation model producing realistic video clips and camera motion.",
    impactSummary:
      "Dream Machine video generation stalls in queue, downloads fail, and API generation requests timeout.",
    keyComponents: [
      "Dream Machine Model Cluster",
    ...
    troubleshootingSteps: [
      "Check Luma AI status and community updates.",
      "Monitor generation queue length in web dashboard.",
      "Retry API requests with exponential backoff.",
      "Verify API credentials and billing tier.",
    ],
  ...
  },
  {
    ...
    description:
      "High-definition generative AI video model creating realistic physical motions and 1080p clips.",
    impactSummary:
      "Video processing gets stuck in pending state, credit deduction succeeds without output, and logins fail.",
    keyComponents: [
      "Diffusion Video Cluster",
      "Motion Brush Engine",
      "Credit & Billing API",
      "Video Hosting CDN",
    ],
    ...
    troubleshootingSteps: [
      "Check Kling AI web portal announcements.",
      "Clear browser cookies and log in again.",
      "Verify account credit balance and concurrent task limit.",
      "Switch video generation to standard quality mode to reduce queue time.",
    ],
  ...
  },
  {
    ...
    description:
      "AI music and song generation platform creating full vocal, lyric, and instrumental tracks.",
    impactSummary:
      "Song generations fail to start, audio playback buffers indefinitely, and stem separation tasks crash.",
    keyComponents: [
    ...
    commonErrorCodes: [
      "500 Internal Server Error",
      "504 Gateway Timeout",
      "503 Audio Engine Busy",
      "429 Rate Limit",
    ],
    troubleshootingSteps: [
      "Check Suno status page and official Discord server announcements.",
      "Refresh player cache and test alternative browser audio codecs.",
      "Retry generation with modified prompt or shorter duration.",
      "Verify active subscription tier and daily generation credits.",
    ],
  ...
  },
  {
    ...
    description:
      "Generative AI music platform enabling musicians to create, extend, and remix vocal and instrumental tracks.",
    impactSummary:
      "Track extensions fail, audio rendering times out, and project saves fail with 500 error.",
    keyComponents: [
      "Music Diffusion Cluster",
    ...
    troubleshootingSteps: [
      "Check Udio status page and community board for maintenance windows.",
      "Export existing stems and tracks locally before retrying.",
      "Clear browser storage and reload the workspace.",
      "Check billing and token allowance.",
    ],
  ...
  },
  {
    ...
    description:
      "AI video effects and animation platform with Pikaffects and generative video transformations.",
    impactSummary:
      "Pikaffects fail to apply, video generation stays queued, and clip downloads fail.",
    keyComponents: [
      "Pikaffects Engine",
    ...
    troubleshootingSteps: [
      "Check Pika Discord server for operational announcements.",
      "Test generation via Discord bot if web UI is unresponsive.",
      "Confirm input video format matches supported MP4/MOV specs.",
      "Retry with reduced length or prompt complexity.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Real-time canvas latency spikes, enhancer upscale jobs fail, and canvas autosave fails.",
    keyComponents: [
      "Real-time Canvas WebSockets",
      "HD Enhancer Pipeline",
      "Image Diffusion Cluster",
      "Auth Gateway",
    ],
    commonErrorCodes: [
    ...
    troubleshootingSteps: [
      "Check Krea status page and Twitter handle @krea_ai.",
      "Check WebSocket connection status in browser developer tools.",
      "Disable aggressive browser ad blockers or privacy extensions.",
      "Restart browser canvas session.",
    ],
  ...
  },
  {
    ...
    description:
      "AI search engine optimized for developers, code search, and technical problem solving.",
    impactSummary:
      "Search queries return 500 errors, VS Code Phind extension disconnects, and web citations fail.",
    keyComponents: [
      "Phind-70B Search Model",
      "Web Index Crawler",
    ...
    troubleshootingSteps: [
      "Check Phind status and community feed.",
      "Switch to fallback search (Perplexity, Google, Kagi).",
      "Verify Phind Pro API key in IDE extension settings.",
      "Clear browser cookies and test in private browsing window.",
    ],
  ...
  },
  {
    ...
    description:
      "Creators of the FLUX.1 family of state-of-the-art text-to-image and visual foundation models.",
    impactSummary:
      "FLUX API image generation requests timeout, model weight download servers throttle, and web demos fail.",
    keyComponents: [
      "FLUX.1 [pro] API",
      "FLUX.1 [dev] Endpoints",
    ...
    troubleshootingSteps: [
      "Check Black Forest Labs status updates and API dashboard.",
      "Route inference through secondary host providers (Fal.ai, Together AI, Replicate).",
      "Verify API balance and rate limits.",
      "Implement client retry logic with jitter.",
    ],
  ...
  },
  {
    ...
    description:
      "Model registry, library, and tool ecosystem for running open-source LLMs locally.",
    impactSummary:
      "ollama pull commands fail with HTTP 500/504, model registry searches fail, and download speeds stall.",
    keyComponents: [
      "Model Registry CDN",
      "Manifest API",
      "Blob Storage Backend",
      "CLI Registry Gateway",
    ],
    commonErrorCodes: [
      "500 Internal Server Error",
      "504 Gateway Timeout",
    ...
    troubleshootingSteps: [
      "Check ollama.com status and GitHub issues repository.",
      "Download model weights from Hugging Face GGUF mirrors as temporary workaround.",
      "Verify local Ollama daemon service is running (ollama serve).",
      "Check internet connection and corporate proxy SSL inspection.",
    ],
  ...
  },
  {
    ...
    description:
      "Open-source, local-first alternative to ChatGPT that runs on your computer with complete privacy.",
    impactSummary:
      "In-app model hub downloads fail, extensions repository is unreachable, and sync services drop.",
    keyComponents: [
      "Model Hub Downloader",
      "Extension Registry",
      "Update Server",
      "Documentation API",
    ],
    ...
    troubleshootingSteps: [
      "Check Jan GitHub repository releases and status.",
      "Manually download GGUF model files and drop into local models folder.",
      "Check local GPU drivers (Vulkan/CUDA/Metal).",
      "Restart Jan desktop application.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Game downloads freeze, Steam Community fails to load, multiplayer matchmaking disconnects, and logins fail.",
    keyComponents: [
      "Steam Store",
      "Steam Community & Friends",
      "Steam Web API",
      "Content Server CDN",
      "Matchmaking Servers",
    ],
    ...
    troubleshootingSteps: [
      "Check unofficial live status at steamstat.us for Tuesday maintenance windows.",
      "Change Steam Download Region in Settings > Downloads.",
      "Clear Steam download cache and restart the client.",
      "Flush DNS cache on local network.",
    ],
  ...
  },
  {
    ...
    description:
      "Sony PlayStation Network for online multiplayer, PlayStation Store, and account management.",
    impactSummary:
      "PS5/PS4 online multiplayer goes offline, PlayStation Store purchases fail, and PSN sign-in throws errors.",
    keyComponents: [
      "Account Management",
      "Gaming and Social",
      "PlayStation Store",
    ...
    troubleshootingSteps: [
      "Check status.playstation.com for service maintenance and region outages.",
      "Test Internet Connection in PS5/PS4 Network Settings.",
      "Restart home router and PlayStation console.",
      "Verify PlayStation Plus subscription status.",
    ],
  ...
  },
  {
    ...
    description:
      "Microsoft gaming and content delivery network for Xbox consoles, PC Game Pass, and Cloud Gaming.",
    impactSummary:
      "Multiplayer party chat disconnects, Cloud Gaming fails to launch, digital game DRM checks fail.",
    keyComponents: [
      "Account & Profile",
      "Multiplayer Gaming",
      "Cloud Gaming",
    ...
    troubleshootingSteps: [
      "Check support.xbox.com/xbox-live-status for outage reports.",
      "Power cycle Xbox console by holding power button for 10 seconds.",
      "Test NAT Type and multiplayer connection in network settings.",
      "Verify Microsoft Account security alerts and credentials.",
    ],
  ...
  },
  {
    ...
    description:
      "Epic Games Store, Fortnite, Rocket League, Unreal Engine services, and Epic Online Services (EOS).",
    impactSummary:
      "Fortnite servers kick players, game launcher fails to verify game files, and Epic Online Services API fails.",
    keyComponents: [
      "Epic Games Launcher",
    ...
    troubleshootingSteps: [
      "Check status.epicgames.com for incident reports and scheduled downtime.",
      "Run Epic Games Launcher as Administrator.",
      "Verify game files through library options menu.",
      "Verify EOS SDK client credentials in developer portal.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Experience teleportation fails, player inventory does not load, avatar editor breaks, and Studio crashes.",
    keyComponents: [
      "Roblox Web Services",
      "Game Server Engine",
      "Roblox Studio API",
    ...
    troubleshootingSteps: [
      "Check status.roblox.com for platform-wide outages.",
      "Check DownDetector and Twitter for spike in user reports.",
      "Reinstall Roblox player client and clear local temporary files.",
      "Verify firewall rules allow UDP ports 49152 - 65535.",
    ],
  ...
  },
  {
    ...
    description:
      "Riot Games online ecosystem supporting League of Legends, Valorant, Teamfight Tactics, and Vanguard.",
    impactSummary:
      "Valorant Vanguard connection error VAN 84/1067, LoL client queue drops, and store transactions fail.",
    keyComponents: [
      "Riot Client Auth",
      "Vanguard Anti-Cheat",
      "League Matchmaking",
      "Valorant Game Servers",
    ],
    commonErrorCodes: ["VAN 84", "VAN 1067", "Error Code 43", "VAL 5", "Queue Join Failed"],
    troubleshootingSteps: [
      "Check status.riotgames.com selecting your specific server region.",
      "Restart vgc service in Windows Services manager.",
      "Check TPM 2.0 and Secure Boot status for Valorant on Windows 11.",
      "Restart Riot Client with Administrator privileges.",
    ],
  ...
  },
  {
    ...
    description:
      "Blizzard Entertainment gaming platform for World of Warcraft, Overwatch 2, Diablo IV, and Hearthstone.",
    impactSummary:
      "Battle.net app login queue gets stuck, game license verification fails, and live multiplayer disconnects.",
    keyComponents: [
      "Battle.net Desktop App",
      "Authentication Servers",
      "Diablo IV Realm Servers",
      "WoW Realms",
    ],
    commonErrorCodes: ["BLZBNTBGS80000011", "BLZBNTAGT00000BB8", "Error 300008", "Code 395002"],
    troubleshootingSteps: [
      "Check @BlizzardCS on X/Twitter and official status page.",
      "Delete the Battle.net Cache and Tools folders in %ProgramData%.",
      "Run the Scan and Repair tool on game files.",
      "Verify firewall exceptions for Battle.net executable.",
    ],
  ...
  },
  {
    ...
    description:
      "Electronic Arts gaming services for EA Sports FC, Apex Legends, Battlefield, and The Sims.",
    impactSummary:
      "Ultimate Team connection drops, EA App shows offline mode, Apex Legends matchmaking loops.",
    keyComponents: [
      "EA Account Identity",
      "Ultimate Team Servers",
    ...
    troubleshootingSteps: [
      "Check @EAHelp on Twitter for live updates on FUT and Apex servers.",
      "Clear EA App cache via App Recovery menu in Start Menu.",
      "Verify EA Account link with platform (PSN, Xbox, Steam).",
      "Restart router to renew external IP.",
    ],
  ...
  },
  {
    ...
    description:
      "Interactive live video streaming service for gaming, esports, music, and creative broadcasts.",
    impactSummary:
      "Live video streams buffer with Error #2000/#3000, chat disconnects from IRC, and streamer ingest drops.",
    keyComponents: [
    ...
    troubleshootingSteps: [
      "Check status.twitch.tv for ingest edge and video playback incidents.",
      "Disable third-party browser extensions (ad blockers, script injectors).",
      "Switch video player quality from Source to 720p60.",
      "Test RTMP ingest stream key and switch broadcast server in OBS.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Feeds fail to load ('You broke Reddit'), comments fail to post with error 500, and voting API hangs.",
    keyComponents: [
      "Reddit Web App",
      "Mobile Apps (iOS/Android)",
      "Reddit Data API",
      "Media CDN (i.redd.it / v.redd.it)",
    ],
    commonErrorCodes: [
    ...
    troubleshootingSteps: [
      "Check redditstatus.com for active incident investigations.",
      "Test old.reddit.com to check if issue is isolated to modern shreddit frontend.",
      "Verify OAuth app token limits on Reddit Developer Portal.",
      "Clear Reddit site data and cookies in browser.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Timeline fails to refresh ('Cannot retrieve posts at this time'), DMs fail to send, API v2 returns 429/503.",
    keyComponents: [
    ...
    troubleshootingSteps: [
      "Check status of X API endpoints on developer portal.",
      "Verify whether rate limits have been hit (monthly tweet cap).",
      "Log out and log back into the web client or iOS/Android app.",
      "Check if CDN edge nodes are blocking traffic.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "For You Page (FYP) feed fails to load, video uploads stall during processing, and live streams drop.",
    keyComponents: [
      "FYP Recommendation Feed",
      "Video CDN",
    ...
    troubleshootingSteps: [
      "Check TikTok app cache in Settings > Free up space > Clear cache.",
      "Switch between Wi-Fi and mobile data to isolate ISP routing issues.",
      "Update TikTok application to latest version in App Store / Play Store.",
      "Check downdetector.com for global network outages.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Stories fail to upload, feed fails to refresh ('Couldn\\'t refresh feed'), and Direct Messages fail to deliver.",
    keyComponents: [
      "Instagram Feed",
      "Stories Infrastructure",
      "Direct Messaging",
      "Graph API / Basic Display",
    ],
    commonErrorCodes: [
      "5xx Server Error",
    ...
    troubleshootingSteps: [
      "Check Meta Status Dashboard for developer graph API health.",
      "Clear Instagram mobile app cache or reinstall application.",
      "Verify two-factor authentication and account security challenges.",
      "Test Web client at instagram.com.",
    ],
  ...
  },
  {
    ...
    description:
      "Meta social platform, Facebook Groups, Messenger, Marketplace, and Meta Business Suite.",
    impactSummary:
      "Meta login SDK fails across third-party websites, ad campaigns stop delivering, Graph API returns 500.",
    keyComponents: [
      "News Feed",
      "Meta Business Suite",
    ...
    troubleshootingSteps: [
      "Check metastatus.com for official business and developer platform alerts.",
      "Verify Meta App access tokens and app review permissions.",
      "Clear browser cookies and disable conflicting privacy add-ons.",
      "Check Facebook Ads Manager status for delivery interruptions.",
    ],
  ...
  },
  {
    ...
    officialStatusUrl: "https://metastatus.com",
    description:
      "Meta's text-based conversation app integrated with Instagram and ActivityPub fediverse protocol.",
    impactSummary:
      "Thread posts fail to publish, feeds fail to update, fediverse federation breaks, and notifications lag.",
    ...
    troubleshootingSteps: [
      "Check Meta Status dashboard for overall infrastructure health.",
      "Relaunch Threads mobile app and verify account session.",
      "Test web experience at threads.net.",
      "Verify Instagram linked login status.",
    ],
  ...
  },
  {
    ...
    description:
      "Multimedia instant messaging app with ephemeral messages, Bitmoji, and AR lenses.",
    impactSummary:
      "Snaps fail to send with red retry arrow, Stories fail to load, and Snap Map features freeze.",
    keyComponents: [
      "Snap Messaging",
      "Stories & Spotlight",
      "Snap Map Location",
      "AR Lens Cloud Engine",
    ],
    commonErrorCodes: [
      "Could not connect",
    ...
    troubleshootingSteps: [
      "Check @snapchatsupport on Twitter and official status page.",
      "Clear Snapchat app cache in App Settings > Account Actions.",
      "Restart device and toggle Wi-Fi / cellular connection.",
  ...
  },
  {
    ...
    impactSummary:
      "Pins fail to save to boards, image thumbnails fail to load, and Pinterest API returns 500.",
    keyComponents: [
    ...
    troubleshootingSteps: [
      "Check status.pinterest.com for infrastructure incidents.",
      "Verify Pinterest API v5 access tokens.",
      "Clear browser cookies and local storage.",
      "Check merchant catalog feed upload status.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "WhatsApp Web QR code fails to pair, messages show single tick (undelivered), and Business API webhooks fail.",
    keyComponents: [
      "WhatsApp Web Multi-Device",
      "E2E Encryption Keyserver",
    ...
    commonErrorCodes: [
      ...
      "QR Code Scan Failed",
      "500 Internal Error",
      "131000 Cloud API Exception",
    ],
    troubleshootingSteps: [
      "Check Meta Status page for WhatsApp Cloud API incidents.",
      "Verify primary mobile phone has active internet connectivity.",
      "Log out from WhatsApp Web and re-link device in Linked Devices menu.",
      "Check local network for WebSocket / port 5222 firewall blocks.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Messages show 'Updating...' or spinning wheel, Telegram bots stop responding, file downloads time out.",
    keyComponents: [
      "Telegram Bot API",
      "MTProto DC Clusters (DC1-DC5)",
      "Media CDN",
      "Telegram Web App",
    ],
    commonErrorCodes: [
    ...
    troubleshootingSteps: [
      "Check Telegram status updates and community reports on Twitter.",
      "Check if your ISP or government network is blocking Telegram data centers (MTProto).",
      "Switch active DC or enable built-in proxy in Telegram Settings > Data and Storage > Proxy.",
      "Verify Bot API token hasn't been revoked.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Messages fail to send or deliver, group calls fail to connect, and desktop client fails to sync.",
    keyComponents: [
      "Signal Server Relay",
    ...
    troubleshootingSteps: [
      "Check status.signal.org and @signalapp on Twitter.",
      "Toggle Censorship Circumvention in Signal Settings > Privacy > Advanced.",
      "Verify phone registration and SMS verification code.",
      "Re-link Signal Desktop in Linked Devices.",
    ],
  ...
  },
  {
    ...
    description:
      "Subscription video on-demand streaming service and Open Connect content delivery network.",
    impactSummary:
      "Videos fail to stream with error codes ui-800-3 or tvq-pb-101, user profiles fail to load.",
    keyComponents: [
      "Open Connect CDN",
    ...
    troubleshootingSteps: [
      "Check official status at help.netflix.com/is-netflix-down.",
      "Restart your Smart TV, streaming box (Roku/Apple TV), or mobile app.",
      "Test network bandwidth at fast.com.",
  ...
  },
  {
    ...
    description:
      "Audio streaming and media services provider offering DRM-protected music and podcasts.",
    impactSummary:
      "Songs pause randomly with 'Can\\'t play this right now', playlists fail to load, Web Playback SDK stops.",
    keyComponents: [
      "Audio Streaming CDN",
      "Web Playback SDK",
      "Spotify Web API",
      "Lyrics & Canvas Service",
    ],
    commonErrorCodes: [
    ...
    troubleshootingSteps: [
      "Check @SpotifyStatus on Twitter for real-time incident reports.",
      "Clear Spotify offline storage cache in Preferences.",
      "Refresh OAuth access tokens in your developer integration.",
      "Switch from offline mode to online mode in playback settings.",
    ],
  ...
  },
  {
    ...
    description:
      "Streaming home for Disney, Pixar, Marvel, Star Wars, and National Geographic content.",
    impactSummary:
      "Video player displays Error Code 83 / 39, downloads fail to authenticate, and logins fail.",
    keyComponents: [
      "Video Ingest & DRM",
      "Subscriber Account API",
      "Content Delivery Network",
      "Profile Management",
    ],
    commonErrorCodes: ["Error Code 83", "Error Code 39", "Error Code 42", "Error Code 14"],
    troubleshootingSteps: [
      "Check help.disneyplus.com and community outage reports.",
      "Ensure device firmware and Disney+ app are updated.",
      "Restart home network modem and router.",
      "Disable VPN connection as Disney+ blocks known VPN IP ranges.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Playback errors (Error 7031 / 5004), live Thursday Night Football stream drops, purchase library unavailable.",
    keyComponents: [
      "Prime Video Streaming CDN",
      "Live Sports Ingest",
      "DRM License Server",
    ...
    troubleshootingSteps: [
      "Check Amazon Health Dashboard and Prime Video Help.",
      "Close background apps on smart TV or streaming device.",
      "Verify HDMI cable supports HDCP 2.2 for 4K content.",
      "Pause other high-bandwidth downloads on local network.",
    ],
  ...
  },
  {
    ...
    description:
      "Warner Bros. Discovery streaming platform offering HBO series, Warner movies, and Discovery content.",
    impactSummary:
      "Episodes fail to buffer during premiere nights, app crashes on startup, subtitles go out of sync.",
    keyComponents: [
      "Max Playback Stream",
      "User Authentication",
      "Live Sports Stream (B/R Sports)",
      "Content Catalog",
    ],
    commonErrorCodes: ["Can't Play Title", "Error 100", "Error 420", "500 Internal Server Error"],
    troubleshootingSteps: [
      "Check help.max.com and social channels during major premiere broadcasts.",
      "Force close and reopen the Max application.",
      "Clear cache and data for the Max app on Android TV or Firestick.",
      "Verify subscription renewal status with provider.",
    ],
  ...
  },
  {
    ...
    description:
      "Apple's music and audio streaming service featuring Lossless and Spatial Audio with Dolby Atmos.",
    impactSummary:
      "Lossless streams fail to initialize, Apple Music web player stalls, and iCloud Music Library sync fails.",
    keyComponents: [
      "Apple Music Catalog",
      "Lossless Audio CDN",
      "MusicKit API",
    ...
    troubleshootingSteps: [
      "Check Apple System Status page for Apple Music outages.",
      "Toggle Sync Library off and on in Music Settings.",
      "Sign out of Media & Purchases in Apple ID settings and sign back in.",
      "Verify MusicKit developer developer token.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Stream stops with 'Video Not Available', MLS live matches stutter, and AirPlay casting fails.",
    keyComponents: [
      "Apple TV App Backend",
      "FairPlay DRM Server",
      "MLS Live Stream",
      "Video Delivery CDN",
    ],
    ...
    troubleshootingSteps: [
      "Check apple.com/support/systemstatus for Apple TV+ service state.",
      "Restart Apple TV hardware or third-party TV app.",
      "Check internet connection speed and HDMI HDCP compliance.",
      "Verify active Apple One or Apple TV+ subscription.",
    ],
  ...
  },
  {
    ...
    description:
      "Online audio distribution platform and music sharing website for independent artists.",
    impactSummary:
      "Track playback stops, waveform fails to render, audio uploads freeze in transcoding.",
    keyComponents: [
    ...
    troubleshootingSteps: [
      "Check status.soundcloud.com for transcoding and API incidents.",
      "Clear browser cache and reload player.",
      "Check artist upload quotas and audio file encoding (WAV/FLAC/MP3).",
      "Verify SoundCloud API client_id validity.",
    ],
  ...
  },
  {
    ...
    description:
      "French music streaming service offering HiFi FLAC audio and Flow personalized radio.",
    impactSummary:
      "Flow fails to generate recommendations, HiFi audio streams drop to low bitrate, logins fail.",
    keyComponents: [
      "Deezer Flow Engine",
      "HiFi Audio CDN",
    ...
    troubleshootingSteps: [
      "Check Deezer Community and status notices.",
      "Reinstall Deezer app or clear cache in Settings.",
      "Verify Deezer Premium / HiFi account status.",
      "Switch audio streaming quality setting to Standard.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Simulcast episode releases crash server with error 'SHAK-1002', subtitles fail to load.",
    keyComponents: [
      "Simulcast Ingest",
      "Video Player CDN",
    ...
    troubleshootingSteps: [
      "Check Crunchyroll status page and @Crunchyroll on Twitter.",
      "Lower video quality from 1080p to 720p during peak simulcast drops.",
      "Clear browser cookies or try private browsing window.",
      "Verify Crunchyroll Mega Fan subscription status.",
    ],
  ...
  },
  {
    ...
    description:
      "Paramount Global streaming service for CBS live TV, UEFA Champions League, and Paramount movies.",
    impactSummary:
      "UEFA Champions League live stream buffers with Error 3304, CBS live feed fails to load.",
    keyComponents: [
      "Live CBS / Sports Ingest",
      "On-Demand Catalog",
      "Ad Insertion Server",
      "DRM Auth",
    ],
    ...
    troubleshootingSteps: [
      "Check help.paramountplus.com for regional live broadcast notices.",
      "Disable ad blocking software which interferes with commercial insertion.",
  ...
  },
  {
    ...
    description:
      "NBCUniversal streaming service offering Premier League soccer, WWE, NBC shows, and Universal films.",
    impactSummary:
      "Premier League and Olympics live feeds fail, error code PAS_4003 displays, authentication loops.",
    keyComponents: [
      "Live Sports Broadcast Ingest",
      "DRM Verification",
      "Ad Server Network",
      "Video Player Engine",
    ],
    ...
    troubleshootingSteps: [
      "Check Peacock Help Twitter @PeacockTVCare.",
      "Restart Peacock streaming application.",
      "Verify HDMI connection and HDCP settings on external displays.",
      "Confirm local network meets 15 Mbps speed requirement for HD live sports.",
    ],
  ...
  },
  {
    ...
    officialStatusUrl: "https://status.stackblitz.com",
    description:
      "Online IDE and WebContainer operating system running Node.js natively in browser tabs.",
    impactSummary:
      "WebContainers fail to start, npm package resolution fails, embedding iframes throw security errors.",
    keyComponents: [
      "WebContainer Core Engine",
      "StackBlitz IDE UI",
      "Package Proxy CDN",
    ...
    troubleshootingSteps: [
      "Check status.stackblitz.com for incident updates.",
      "Ensure browser supports Cross-Origin-Embedder-Policy (COEP) and SharedArrayBuffer.",
      "Hard reload browser tab without cache (Ctrl+F5 / Cmd+Shift+R).",
      "Test in Chrome or Edge if running on an unsupported mobile browser.",
    ],
  ...
  },
  {
    ...
    description:
      "Collaborative browser-based software development platform, agentic AI creator, and deployment cloud.",
    impactSummary:
      "Repl containers fail to boot, Replit Agent stops generating diffs, live custom domains 502 bad gateway.",
    keyComponents: [
      "Repl Container Cluster",
      "Replit Agent AI",
      "Custom Domain Proxy",
    ...
    troubleshootingSteps: [
      "Check status.replit.com for VM cluster disruptions.",
      "Restart the Repl container via Shell (kill 1).",
      "Check resource utilization (CPU and RAM limits in dashboard).",
      "Inspect deployment logs in deployments tab.",
    ],
  ...
  },
  {
    ...
    description:
      "Automated cloud development environment platform that spins up fresh, automated dev workspaces.",
    impactSummary:
      "Workspace creation fails during prebuild, VS Code browser extension fails to connect, SSH gateway drops.",
    keyComponents: [
      "Workspace Daemon",
      "Prebuild Engine",
      "SSH Gateway",
    ...
    troubleshootingSteps: [
      "Check status.gitpod.io for cluster outages across regions.",
      "Stop and restart the workspace from gitpod.io/workspaces.",
      "Review .gitpod.yml configuration file for breaking setup tasks.",
      "Re-authenticate Git provider integration.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Node apps fail to wake from sleep, project editor disconnects from container, remixing projects fails.",
    keyComponents: [
      "Container Hosting Fleet",
      "Live Code Editor",
      "Project Search & Remix",
      "Auth & Community",
    ],
    commonErrorCodes: [
    ...
    troubleshootingSteps: [
      "Check status.glitch.com for maintenance and container fleet issues.",
      "Open Glitch terminal and run 'refresh' or check disk space.",
  ...
  },
  {
    ...
    description: "Hosted continuous integration service used to build and test software projects.",
    impactSummary:
      "Build queues back up for hours, GitHub commit status checks do not update, credit allowance blocks builds.",
    keyComponents: [
      "Build Matrix Coordinator",
      "macOS/Linux Worker Fleet",
    ...
    troubleshootingSteps: [
      "Check traviscistatus.com for worker VM availability.",
      "Verify Travis CI plan credits in organization settings.",
      "Test build locally with Docker to verify .travis.yml script.",
      "Re-trigger build manually in Travis dashboard.",
    ],
  ...
  },
  {
    ...
    description:
      "Continuous integration and deployment service specialized in Windows and multi-platform build environments.",
    impactSummary:
      "Windows build workers fail to provision, artifact storage uploads fail, deployment agents lose connection.",
    keyComponents: [
      "Windows VM Worker Fleet",
      "Linux Worker Nodes",
      "Artifact Storage CDN",
      "Deployment Agents",
    ],
    commonErrorCodes: [
      "Build Worker Timeout",
      "500 Internal Error",
      "Artifact Upload Failed",
      "503 Service Unavailable",
    ],
    troubleshootingSteps: [
      "Check status.appveyor.com for cloud worker status.",
      "Verify appveyor.yml syntax in online validator.",
      "Review build memory usage on Windows worker machines.",
      "Switch build cloud image in project settings.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Live code preview fails to compile Sass/Babel/TypeScript, pen saves fail, asset hosting returns 404.",
    keyComponents: [
      "Frontend Preprocessor Engine",
      "Live Iframe Sandbox",
      "Asset Hosting CDN",
      "PRO Collaboration Mode",
    ],
    commonErrorCodes: [
      "500 Internal Error",
      "Compilation Error",
    ...
    troubleshootingSteps: [
      "Check status.codepen.io for service disruptions.",
      "Check browser developer console for JS runtime errors inside iframe.",
      "Export code to zip or GitHub Gist.",
      "Disable preprocessors (switch Babel/Sass to raw JS/CSS) to isolate compiler issue.",
    ],
  ...
  },
  {
    ...
    description:
      "Online playground for testing and showcasing HTML, CSS and JavaScript code snippets.",
    impactSummary:
      "Fiddle snippets fail to save, external resources CDN fails to inject, result iframe stays blank.",
    keyComponents: [
      "Fiddle Runner Iframe",
    ...
    troubleshootingSteps: [
      "Check JSFiddle web server response.",
      "Copy code to local scratchpad or alternative sandbox.",
      "Verify external resource URLs are served over HTTPS.",
  ...
  },
  {
    ...
    apiEndpoint: "https://registry.npmjs.org",
    description:
      "Default package manager and global registry for JavaScript and Node.js ecosystems.",
    impactSummary:
      "npm install, yarn add, and bun install fail with E500/E503, 2FA publish auth fails, CI pipelines stall.",
    keyComponents: [
      "Package Metadata API",
      "Tarball Download CDN",
      "npm publish Pipeline",
      "Two-Factor Auth Gateway",
    ],
    commonErrorCodes: [
    ...
    troubleshootingSteps: [
      "Check status.npmjs.org for registry incident reports.",
      "Temporarily point npm registry to Cloudflare or Yarn mirror (npm config set registry https://registry.yarnpkg.com).",
      "Clear local npm cache (npm cache clean --force).",
      "Verify NPM_TOKEN credentials in CI environment variables.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "pip install and poetry install fail with Connection Timeout / 503, twine publish fails with 500.",
    keyComponents: [
      "PyPI Warehouse Web App",
      "Fastly Global CDN",
      "PyPI Simple API",
    ...
    troubleshootingSteps: [
      "Check status.python.org for PyPI maintenance or Fastly CDN degradations.",
      "Use an official PyPI mirror (e.g. Tsinghua or AWS CodeArtifact).",
      "Run pip install with --no-cache-dir flag.",
      "Verify API token or Trusted Publisher OIDC configuration.",
    ],
  ...
  },
  {
    ...
    description:
      "Official Rust package registry for cargo dependencies, crate publishing, and docs.",
    impactSummary:
      "cargo build fails during dependency resolution with HTTP 500/503, cargo publish hangs.",
    keyComponents: [
      "Sparse Index HTTP Service",
      "Tarball Storage S3",
      "Crates.io Web App",
      "GitHub Index Mirror",
    ],
    commonErrorCodes: [
      "failed to fetch `https://index.crates.io`",
      "503 Service Unavailable",
      "500 Server Error",
    ],
    troubleshootingSteps: [
      "Check status.crates.io for sparse index or crate storage incidents.",
      "Ensure Cargo is using the sparse index protocol in modern Rust (CARGO_REGISTRIES_CRATES_IO_PROTOCOL=sparse).",
      "Check local internet connection and proxy settings.",
      "Verify crates.io API token.",
    ],
  ...
  },
  {
    ...
    description:
      "Container registry service and repository for official and community Docker container images.",
    impactSummary:
      "docker pull fails with 'toomanyrequests' or 503, automated container builds fail, push tasks timeout.",
    keyComponents: [
      "Docker Image Registry v2 API",
      "Docker Hub Web Portal",
      "Automated Build Fleet",
    ...
    troubleshootingSteps: [
      "Check dockerstatus.com for Hub API and Registry disruptions.",
      "Log in with an authenticated Docker Hub account to increase rate limits (docker login).",
      "Switch to fallback container registries (GitHub Container Registry ghcr.io, AWS ECR Public, Quay.io).",
  ...
  },
  {
    ...
    officialStatusUrl: "https://status.hashicorp.com",
    description:
      "HashiCorp's managed service for Terraform runs, state management, and infrastructure automation.",
    impactSummary:
      "terraform plan / apply runs stall in queue, remote state locking fails, VCS webhooks do not trigger.",
    keyComponents: [
      "Terraform Run Execution Engine",
    ...
    troubleshootingSteps: [
      "Check status.hashicorp.com for Terraform Cloud API and Runner incidents.",
      "Force unlock state in Terraform Cloud workspace settings if run is orphaned.",
      "Verify VCS token (GitHub/GitLab) permissions.",
      "Execute run locally using local backend as emergency fallback.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "pulumi up commands fail to acquire stack lease, state updates fail to persist, CI deployments fail.",
    keyComponents: [
      "Stack State Backend",
    ...
    commonErrorCodes: [
      "Conflict: Stack is currently locked",
      "500 Internal Server Error",
      "504 Gateway Timeout",
    ],
    troubleshootingSteps: [
      "Check status.pulumi.com for backend availability.",
      "Unlock stack with pulumi stack unlock command.",
      "Verify PULUMI_ACCESS_TOKEN environment variable.",
      "Check local network connectivity to api.pulumi.com.",
    ],
  ...
  },
  {
    ...
    officialStatusUrl: "https://status.circleci.com",
    description:
      "Continuous integration and delivery platform automating software testing and releases.",
    impactSummary:
      "Workflows do not start on git push, Docker executor pulls fail, test results fail to report to GitHub.",
    keyComponents: [
      "Workflow Scheduler",
      "Compute Fleet (Docker/Machine)",
      "Artifact Storage CDN",
    ...
    troubleshootingSteps: [
      "Check status.circleci.com for scheduler and webhook status.",
      "Re-run workflow from failed in CircleCI dashboard.",
      "Verify project environment variables and contexts.",
      "Test config syntax locally with circleci config validate CLI.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "VPN connection hangs at 'Authenticating', Secure Core servers drop, P2P servers disconnect.",
    keyComponents: [
      "WireGuard & OpenVPN Gateways",
      "Secure Core Network",
      "NetShield Ad-blocker DNS",
      "Auth & Licensing API",
    ],
    commonErrorCodes: [
      "Connection Timed Out",
    ...
    troubleshootingSteps: [
      "Check status.proton.me for server maintenance and network alerts.",
      "Switch VPN protocol from WireGuard to OpenVPN (TCP) in app settings.",
      "Connect to a different country or server location.",
  ...
  },
  {
    ...
    impactSummary:
      "NordLynx adapter fails to assign IP, Quick Connect loops indefinitely, streaming server blocked.",
    keyComponents: [
      "NordLynx (WireGuard) Servers",
    ...
    troubleshootingSteps: [
      "Check nordstatus.com for server updates.",
      "Change protocol to OpenVPN or NordLynx in NordVPN settings.",
      "Reset network stack and flush DNS in Windows/macOS.",
      "Restart NordVPN service daemon.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Kill Switch activates unexpectedly, connection drops on Wi-Fi switch, bypasser rules fail.",
    keyComponents: [
      "Global VPN Edge Nodes",
      "CleanWeb DNS Engine",
      "MultiHop Tunnel Service",
      "WireGuard Protocol Endpoints",
    ],
    commonErrorCodes: [
      "Connection Failed",
    ...
    troubleshootingSteps: [
      "Test alternative server city or protocol (IKEv2/WireGuard).",
      "Toggle Kill Switch in app settings to restore direct internet.",
      "Verify subscription billing on Surfshark account page.",
      "Reinstall virtual network adapter.",
    ],
  ...
  },
  {
    ...
    description:
      "Privacy-first VPN service that requires no email or personal details to create an account.",
    impactSummary:
      "WireGuard key generation fails, server relays reject key, connection stalls at handshake.",
    keyComponents: [
      "WireGuard Relay Servers",
    ...
    troubleshootingSteps: [
      "Check server list status at mullvad.net/en/servers.",
      "Generate a new WireGuard key in Mullvad app settings.",
      "Verify remaining time on 16-digit account number.",
      "Select a different country relay.",
    ],
  ...
  },
  {
    ...
    description:
      "Software-defined global networking that connects devices directly in peer-to-peer mesh networks.",
    impactSummary:
      "Virtual network adapters stay in ACCESS_DENIED or REQUESTING_CONFIGURATION, peers show offline.",
    keyComponents: [
      "Roots (Planetary Root Servers)",
      "Network Controller API",
      "ZeroTier Central Web App",
      "Peer Discovery Relays",
    ],
    commonErrorCodes: ["REQUESTING_CONFIGURATION", "ACCESS_DENIED", "OFFLINE", "PORT_ERROR"],
    troubleshootingSteps: [
      "Check status.zerotier.com for Root Server and Central Controller health.",
      "Authorize node ID in ZeroTier Central network settings.",
      "Restart ZeroTier One service in operating system services.",
      "Verify UDP port 9993 is not blocked by local ISP/firewall.",
    ],
  ...
  },
  {
    ...
    officialStatusUrl: "https://www.cloudflarestatus.com",
    description:
      "Fast, modern, private VPN and DNS resolver powered by Cloudflare's global edge network.",
    impactSummary:
      "Internet cuts off when WARP connects, DNS resolution fails, Zero Trust posture checks fail.",
    keyComponents: [
      "1.1.1.1 Anycast DNS",
      "WARP WireGuard Edge",
      "Zero Trust Gateway",
    ...
    commonErrorCodes: [
      ...
      "Registration Failed",
      "WARP Disconnected",
      "503 Edge Unavailable",
    ],
    troubleshootingSteps: [
      "Check cloudflarestatus.com for Cloudflare WARP and Zero Trust incidents.",
      "Toggle WARP connection off and on or switch to '1.1.1.1 only (DoH)' mode.",
      "Reset WARP registration in Settings > Preferences > Account > Reset Registration.",
  ...
  },
  {
    ...
    description:
      "Premium email, contacts, and calendar service focused on privacy and open standards (JMAP/IMAP).",
    impactSummary:
      "Incoming emails delayed, JMAP web client disconnects, custom domain MX routing fails.",
    keyComponents: [
      "JMAP Web & Mobile Backend",
    ...
    commonErrorCodes: [
      "500 Internal Error",
      "Connection to mail server dropped",
      "504 Gateway Timeout",
      "SMTP Error 554",
    ],
    troubleshootingSteps: [
      "Check fastmailstatus.com and @Fastmail on Twitter.",
      "Verify custom domain DNS records (MX, DKIM, SPF).",
      "Generate an App Password for third-party email clients.",
      "Check spam quarantine and rule filters.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Encrypted mailbox decryption fails, Proton Mail Bridge disconnects from Outlook/Thunderbird, emails bounce.",
    keyComponents: [
      "Zero-Access Mail Encryption",
      "Proton Mail Bridge",
      "Web & Mobile Clients",
      "Custom Domain MX Cluster",
    ],
    commonErrorCodes: [
      "Decryption Error",
      "503 Service Unavailable",
    ...
    troubleshootingSteps: [
      "Check status.proton.me for infrastructure and DDOS attack mitigation updates.",
      "Restart Proton Mail Bridge on desktop.",
      "Verify Proton account password and mailbox key integrity.",
      "Test webmail at mail.proton.me.",
    ],
  ...
  },
  {
    ...
    description:
      "End-to-end encrypted email and calendar provider with quantum-resistant encryption.",
    impactSummary:
      "Inbox fails to sync, two-factor auth prompt hangs, custom domain emails fail to deliver.",
    keyComponents: [
    ...
    troubleshootingSteps: [
      "Check status.tuta.com for server updates.",
      "Check if local ISP is blocking Tuta DNS or IP addresses.",
      "Clear browser cache and reload web app.",
      "Verify recovery code if locked out.",
    ],
  ...
  },
  {
    ...
    description:
      "German cloud hosting provider offering high-performance VPS, VDS, and Dedicated Servers.",
    impactSummary:
      "VPS instances become unreachable via SSH, network bandwidth drops, storage IOPS bottlenecks.",
    keyComponents: [
      "Data Centers (EU/US/Asia)",
    ...
    commonErrorCodes: [
      ...
      "500 Control Panel Error",
      "Host System Storage Bottleneck",
    ],
    troubleshootingSteps: [
      "Check contabo-status.net for maintenance in your data center region (e.g. EU-Central).",
      "Access server via VNC / Web Console in Contabo Control Panel.",
      "Reboot VPS from customer panel.",
      "Inspect server resource consumption (CPU, RAM, Disk I/O).",
    ],
  ...
  },
  {
    ...
    description:
      "Global cloud services platform offering enterprise cloud infrastructure, VPS, and load balancers.",
    impactSummary:
      "Cloud servers stop responding, load balancers fail health checks, provisioning times out.",
    keyComponents: [
    ...
    troubleshootingSteps: [
      "Check Kamatera console status and support notifications.",
      "Use Kamatera web console to diagnose OS kernel panic or network issues.",
      "Check firewall rules assigned to the server.",
      "Open support ticket via management portal.",
    ],
  ...
  },
  {
    ...
    officialStatusUrl: "https://status.scaleway.com",
    description:
      "European cloud provider offering compute instances, Kubernetes Kapsule, Object Storage, and AI servers.",
    impactSummary:
      "Kapsule Kubernetes control plane hangs, Object Storage PUT requests fail with 500, instances freeze.",
    keyComponents: [
      "Instances & BareMetal",
      "Kubernetes Kapsule",
    ...
    troubleshootingSteps: [
      "Check status.scaleway.com for regional incidents (fr-par, nl-ams, pl-waw).",
      "Verify Scaleway API token and project permissions.",
      "Restart compute instance via Scaleway Console or CLI (scw instance server reboot).",
      "Inspect system logs using Serial Console.",
    ],
  ...
  },
  {
    ...
    description:
      "Mobile payment service developed by Block, Inc., allowing peer-to-peer money transfers, Bitcoin, and stocks.",
    impactSummary:
      "Cash Card transactions decline at point of sale, instant deposits stall, P2P payments fail with 'Failed'.",
    keyComponents: [
      "P2P Payments Engine",
      "Cash Card Debit Network",
      "Bitcoin Trading API",
      "Direct Deposit Clearing",
    ],
    commonErrorCodes: ["Payment Failed", "Declined", "500 Server Error", "Connection Lost"],
    troubleshootingSteps: [
      "Check status.cash.app for transaction processing degradations.",
      "Verify debit card / bank account link in Cash App profile.",
      "Check Cash App daily sending limits.",
      "Contact Cash App support via in-app help chat.",
    ],
  ...
  },
  {
    ...
    description:
      "PayPal-owned mobile payment service for social payments between friends and authorized merchants.",
    impactSummary:
      "Bank transfers fail, payments get stuck in pending state, Venmo Mastercard declines, login 2FA fails.",
    keyComponents: [
      "Social Payment Engine",
      "Venmo Debit & Credit Card",
      "Bank ACH Processing",
    ...
    troubleshootingSteps: [
      "Check Venmo status and PayPal status dashboards.",
      "Verify connected bank account or debit card validity.",
      "Check Venmo identity verification status.",
      "Re-attempt payment after 15 minutes to clear fraud detection flags.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Market orders fail to execute during market open, options chains fail to load, portfolio charts freeze.",
    keyComponents: [
      "Equities Order Routing",
      "Options Clearing",
    ...
    troubleshootingSteps: [
      "Check status.robinhood.com for market execution engine alerts.",
      "Log out and log back in to refresh auth session and socket data.",
      "Verify buying power and unsettled funds in account tab.",
      "Contact 24/7 Robinhood support via phone callback.",
    ],
  ...
  },
  {
    ...
    description:
      "Global cryptocurrency exchange supporting spot trading, futures, margin, and blockchain ecosystem.",
    impactSummary:
      "Futures liquidations lag, Spot API returns 502/429, crypto deposits/withdrawals suspended.",
    keyComponents: [
      "Spot Matching Engine",
      "Futures Order Gateway",
      "WebSocket Market Streams",
      "Wallet Ingest & Withdrawal",
    ],
    commonErrorCodes: [
    ...
    troubleshootingSteps: [
      "Check Binance System Status and @BinanceHelpDesk on Twitter.",
      "Synchronize system clock (NTP) to fix -1021 timestamp signature errors.",
      "Switch API endpoints (api1.binance.com, api2.binance.com, api3.binance.com).",
      "Check wallet maintenance notices for specific token networks.",
    ],
  ...
  },
  {
    ...
    description:
      "Cryptocurrency exchange and bank offering spot and futures trading with advanced order types.",
    impactSummary:
      "REST and WebSockets API disconnect during high volatility, order submission throws EOrder errors.",
    keyComponents: [
      "Trading Engine",
      "WebSockets Public/Private Feed",
      "Funding (Fiat/Crypto)",
      "Kraken Pro Web/App",
    ],
    commonErrorCodes: [
    ...
    troubleshootingSteps: [
      "Check status.kraken.com for matching engine maintenance.",
      "Implement rate limit backoff in API bot algorithms.",
      "Use WebSocket v2 feeds for lower latency order books.",
      "Verify API key permissions and IP whitelisting.",
    ],
  ...
  },
  {
    ...
    description:
      "Cryptocurrency derivatives and spot trading platform with high-frequency trading capabilities.",
    impactSummary:
      "Derivatives orderbook freezes, V5 unified API requests drop, margin calculations time out.",
    keyComponents: [
    ...
    troubleshootingSteps: [
      "Check status.bybit.com for server updates.",
      "Verify NTP server time synchronization.",
      "Check subaccount API key permissions (Read-Write, Contract, Spot).",
      "Switch to alternative API domains.",
    ],
  ...
  },
  {
    ...
    description:
      "Innovative cryptocurrency exchange with Web3 Wallet, DeFi integrations, and derivatives.",
    impactSummary:
      "WebSocket connections drop, market data feeds lag, Web3 wallet RPC endpoints fail.",
    keyComponents: [
      "V5 Market Data API",
      "Trade Matching Engine",
      "OKX Web3 Wallet Gateway",
      "Settlement Engine",
    ],
    commonErrorCodes: ["50001 Server busy", "50004 Rate limit", "502 Bad Gateway", "504 Timeout"],
    troubleshootingSteps: [
      "Check status.okx.com for system upgrades.",
      "Switch WebSocket connections to backup server URLs.",
      "Review rate limit compliance per API key tier.",
      "Verify KYC verification tier.",
    ],
  ...
  },
  {
    ...
    description:
      "Global e-commerce marketplace, 1-Click checkout, Prime delivery, and Seller Central platform.",
    impactSummary:
      "Add to Cart button fails, checkout errors 'An error occurred when we tried to process your request', Seller Central SP-API drops.",
    keyComponents: [
      "Amazon Shopping Cart & Checkout",
      "Selling Partner API (SP-API)",
      "Product Catalog CDN",
      "Prime Delivery Routing",
    ],
    commonErrorCodes: [
      "500 Internal Server Error",
      "503 Service Unavailable",
    ...
    troubleshootingSteps: [
      "Check AWS health dashboard and Amazon Seller Central announcements.",
      "Clear browser cookies and cache or test in Amazon mobile app.",
      "For SP-API developers, check token expiration and LWA (Login with Amazon) refresh token.",
      "Retry checkout with alternative payment method.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Auction bids fail in final seconds, seller inventory sync fails, eBay REST API throws 500.",
    keyComponents: [
      "Bidding Engine",
      "Search & Listing Catalog",
      "eBay REST APIs",
      "Managed Payments Gateway",
    ],
    commonErrorCodes: [
      "500 Internal Server Error",
      "504 Gateway Timeout",
      "21919301 Call failed",
      "429 Too Many Requests",
    ],
    troubleshootingSteps: [
      "Check ebay.com/sts for system status and scheduled maintenance.",
      "Verify OAuth User Token scope in eBay Developer Portal.",
      "Clear browser cookies and session data.",
      "Inspect inventory bulk feed error logs in Seller Hub.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Shop checkout fails, order notifications drop, Etsy v3 Open API returns 500/504 errors.",
    keyComponents: [
      "Etsy Shop Engine",
      "Checkout & Payments",
      "Etsy Open API v3",
    ...
    troubleshootingSteps: [
      "Check status.etsy.com for payments and seller tool outages.",
      "Verify API keystring and OAuth refresh tokens for Etsy Open API v3.",
      "Test payment in private browsing mode.",
      "Review shop payment account standing in Shop Manager.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Ride requests fail with 'Something went wrong', driver dispatch maps disconnect, fare estimation fails.",
    keyComponents: [
    ...
    troubleshootingSteps: [
      "Check status.uber.com and local driver reports.",
      "Force quit Uber app and restart mobile device.",
      "Verify GPS and location permissions in phone settings.",
      "Switch payment method (Apple Pay / Credit Card / Cash).",
    ],
  ...
  },
  {
    ...
    officialStatusUrl: "https://status.uber.com",
    description:
      "Online food ordering and delivery platform connecting customers with local restaurants.",
    impactSummary:
      "Restaurant orders fail to submit, merchant tablets lose connection, order tracking GPS freezes.",
    keyComponents: [
      "Restaurant POS Integration API",
      "Order Dispatch Engine",
      "Driver Fleet Routing",
      "Payment Processing",
    ],
    commonErrorCodes: ["Order Submission Failed", "500 Server Error", "Merchant Tablet Offline"],
    troubleshootingSteps: [
      "Check status.uber.com for merchant platform issues.",
      "Restart Uber Eats app and clear cart cache.",
      "Check restaurant opening hours and tablet online indicator.",
      "Verify credit card / billing information.",
    ],
  ...
  },
  {
    ...
    description:
      "On-demand local logistics platform for restaurant food delivery, grocery, and convenience stores.",
    impactSummary:
      "Dasher app crashes, customer orders get stuck at checkout, restaurant merchant portal goes offline.",
    keyComponents: [
      "Dasher Dispatch Engine",
      "Merchant Portal POS API",
    ...
    troubleshootingSteps: [
      "Check status.doordash.com for active system incidents.",
      "Force close Dasher or Customer mobile app.",
      "Check Dasher Red Card balance and cellular signal.",
      "Verify DoorDash Drive API credentials.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Delivery windows fail to load, shopper barcode scanning errors out, order checkout fails.",
    keyComponents: [
      "Shopper App Scanning",
    ...
    commonErrorCodes: [
      "500 Server Error",
      "Delivery times unavailable",
      "Failed to process payment",
    ],
    troubleshootingSteps: [
      "Check status.instacart.com for retailer integration and shopper app disruptions.",
      "Restart Instacart mobile app.",
      "Select alternative delivery window or replacement store.",
      "Verify payment card security code.",
    ],
  ...
  },
  {
    ...
    officialStatusUrl: "https://status.office365.com",
    description:
      "Productivity cloud suite including Word, Excel, PowerPoint, Teams, SharePoint, and Entra ID.",
    impactSummary:
      "Office web apps return 500 errors, cloud autosave fails, admin center is unreachable, logins fail globally.",
    keyComponents: [
    ...
    troubleshootingSteps: [
      "Check status.office365.com and @MSFT365Status on Twitter for global tenant alerts.",
      "Verify tenant health in Microsoft 365 Admin Center Service Health dashboard.",
      "Test document editing in desktop Office apps in offline mode.",
      "Flush local DNS cache and verify network connectivity.",
    ],
  ...
  },
  {
    ...
    officialStatusUrl: "https://status.office365.com",
    description:
      "Enterprise email, calendaring, and contact management web service powered by Exchange Online.",
    impactSummary:
      "Emails fail to send/receive, Outlook Web App shows blank blue screen, calendar invitations bounce.",
    keyComponents: [
    ...
    commonErrorCodes: [
      ...
      "503 Service Unavailable",
      "Mailbox Unavailable 554",
      "HTTP 504 Gateway Timeout",
    ],
    troubleshootingSteps: [
      "Check Microsoft 365 Service Health for Exchange Online advisory notices.",
      "Open Outlook in private browsing mode to rule out caching issues.",
      "Test desktop Outlook client using Cached Exchange Mode.",
      "Verify MX and SPF records in domain DNS.",
    ],
  ...
  },
  {
    ...
    officialStatusUrl: "https://status.office365.com",
    description:
      "Microsoft's cloud file storage and synchronization service for personal and enterprise accounts.",
    impactSummary:
      "File sync gets stuck with 'Processing changes', file sharing links fail, storage quota errors display.",
    keyComponents: [
      "OneDrive Sync Client",
      "SharePoint File Backend",
    ...
    troubleshootingSteps: [
      "Check Microsoft 365 status for SharePoint/OneDrive outages.",
      "Reset OneDrive desktop client (%localappdata%\\Microsoft\\OneDrive\\onedrive.exe /reset).",
      "Pause and resume syncing in OneDrive system tray icon.",
      "Test web access at onedrive.live.com.",
    ],
  ...
  },
  {
    ...
    description:
      "Google's cloud file storage, synchronization, Google Docs, Sheets, and Slides workspace.",
    impactSummary:
      "Google Docs fails to autosave ('Trying to connect...'), files fail to upload, Drive API returns 500.",
    keyComponents: [
      "Drive Cloud Storage",
      "Docs Realtime Collaboration",
      "Google Drive API v3",
      "Drive for Desktop Client",
    ],
    commonErrorCodes: [
      "Trying to connect...",
      "500 Internal Error",
    ...
    troubleshootingSteps: [
      "Check Google Workspace Status Dashboard for Google Drive outages.",
      "Switch to offline editing mode in Google Docs settings.",
      "Clear browser cookies and cached images for google.com.",
      "Verify Google Drive API quota in Google Cloud Console.",
    ],
  ...
  },
  {
    ...
    officialStatusUrl: "https://www.google.com/appsstatus/dashboard",
    description:
      "Video communication service developed by Google for high-definition video meetings.",
    impactSummary:
      "Meetings fail to join with 'You can\\'t join this video call', camera and audio streams disconnect.",
    keyComponents: [
      "WebRTC Media Server",
    ...
    troubleshootingSteps: [
      "Check Google Workspace Status Dashboard for Meet incidents.",
      "Check browser camera and microphone permissions.",
      "Test WebRTC connectivity and UDP ports 19302-19309.",
      "Re-generate meeting link in Google Calendar.",
    ],
  ...
  },
  {
    ...
    officialStatusUrl: "https://www.apple.com/support/systemstatus",
    description:
      "Apple cloud storage and computing service covering Photos, Drive, Keychain, Backup, and Private Relay.",
    impactSummary:
      "iCloud Backup fails, Apple Photos do not sync, iCloud Keychain sync stalls, Private Relay disconnects.",
    keyComponents: [
      "iCloud Drive",
      "iCloud Photos",
      "iCloud Keychain",
    ...
    troubleshootingSteps: [
      "Check apple.com/support/systemstatus for iCloud services.",
      "Toggle iCloud Private Relay off and on in Apple ID settings.",
      "Sign out of Apple ID on device and sign back in.",
      "Check available iCloud storage in Settings.",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Campfire chats fail to send, To-do lists fail to check off, file uploads stall, Webhooks fail.",
    keyComponents: [
      "Basecamp App Engine",
      "Campfire Chat WebSockets",
      "File Storage CDN",
      "Basecamp API v3",
    ],
    commonErrorCodes: ["500 Internal Server Error", "502 Bad Gateway", "504 Gateway Timeout"],
    troubleshootingSteps: [
      "Check basecampstatus.com and @basecamp on Twitter.",
      "Clear browser cookies and reload app.",
      "Check project permissions and user access levels.",
      "Verify Basecamp API access tokens.",
    ],
  ...
  },
  {
    ...
    description:
      "Cloud file hosting, synchronization, personal cloud, and client software service.",
    impactSummary:
      "Desktop client shows 'Connecting...', shared links throw 500 errors, Paper docs fail to save.",
    keyComponents: [
      "Sync Engine & Block Storage",
      "Dropbox Paper",
      "Dropbox API v2",
      "Sign & DocSend",
    ],
    ...
    troubleshootingSteps: [
      "Check status.dropbox.com for file syncing and API incidents.",
      "Restart Dropbox desktop client.",
      "Check account storage capacity and selective sync settings.",
      "Verify API v2 authorization token.",
    ],
  ...
  },
  {
    ...
    description:
      "Cloud content management and file sharing service for businesses and enterprise teams.",
    impactSummary:
      "Box Drive sync disconnects, Single Sign-On (SSO) fails, Box Sign transactions time out.",
    keyComponents: [
      "Box Content API",
      "Box Drive Client",
      "Enterprise SSO (SAML)",
    ...
    troubleshootingSteps: [
      "Check status.box.com for enterprise cluster notifications.",
      "Log out and re-authenticate Box Drive on desktop.",
      "Check Box Admin Console for security policy restrictions.",
      "Verify Box Developer API JWT / OAuth2 credentials.",
    ],
  ...
  },
  {
    ...
    description:
      "Note-taking and task organization application with cross-platform synchronization.",
    impactSummary:
      "Notes fail to sync between devices, note content reverts to previous version, web clipper fails.",
    keyComponents: [
      "Note Sync Service",
      "Evernote Web App",
      "Web Clipper API",
    ...
    troubleshootingSteps: [
      "Check status.evernote.com for cloud sync incidents.",
      "Manually trigger sync in Evernote File > Sync.",
      "Export unsynced notes to ENEX format to avoid data loss.",
      "Update Evernote desktop and mobile apps to latest version.",
    ],
  ...
  },
  {
    ...
    description:
      "Task management and productivity software for personal and team task organization.",
    impactSummary:
      "Tasks fail to check off, recurring schedules stop updating, calendar two-way sync disconnects.",
    keyComponents: [
      "Task Sync Engine",
      "Todoist REST API v2",
    ...
    troubleshootingSteps: [
      "Check status.todoist.net for API and sync health.",
      "Log out and log back in to force a fresh sync of the task database.",
      "Verify Todoist API v2 token in integration settings.",
      "Check browser extensions for conflict.",
    ],
  ...
  },
  {
    ...
    description:
      "All-in-one collaborative doc platform that combines documents, spreadsheets, and building blocks.",
    impactSummary:
      "Coda doc formulas fail to calculate, Packs integrations stop syncing, doc automation rules fail.",
    keyComponents: [
      "Coda Calculation Engine",
      "Packs API Ecosystem",
    ...
    troubleshootingSteps: [
      "Check status.coda.io for engine and Packs performance.",
      "Refresh browser doc tab.",
      "Review Pack account connections in Doc Settings > Packs.",
      "Verify Coda API token rate limits.",
    ],
  ...
  },
  {
    ...
    officialStatusUrl: "https://status.twilio.com",
    description:
      "Two-factor authentication app and API developed by Twilio for securing user logins.",
    impactSummary:
      "2FA push notifications fail to arrive, SMS OTPs fail to deliver, Authy app multi-device sync fails.",
    keyComponents: [
      "Push Authentication Service",
      "SMS OTP Delivery Gateway",
      "Device Sync Cloud",
      "Authy REST API",
    ],
    commonErrorCodes: [
    ...
    troubleshootingSteps: [
      "Check status.twilio.com for Authy API and SMS delivery status.",
      "Use 6-digit TOTP token manually instead of waiting for push notification.",
      "Check mobile device notification settings.",
      "Verify phone number on account.",
    ],
  ...
  },
  {
    ...
    description:
      "Enterprise multi-factor authentication (MFA), single sign-on, and secure access platform.",
    impactSummary:
      "Duo Push fails to trigger on employee phones, SSO gateway rejects credentials, VPN access blocks.",
    keyComponents: [
      "Duo Push Notification Service",
      "Duo SSO / SAML Proxy",
      "Admin API & Dashboard",
      "Directory Sync",
    ],
    ...
    troubleshootingSteps: [
      "Check status.duo.com for regional deployment status.",
      "Generate a passcode in the Duo Mobile app or use hardware security key (FIDO2).",
      "Verify company VPN and network settings.",
      "Contact enterprise IT helpdesk to issue bypass code.",
    ],
  ...
  },
  {
    ...
    description:
      "Enterprise identity and access management (IAM), SSO, directory, and multi-factor authentication.",
    impactSummary:
      "PingFederate SSO tokens fail to issue, PingOne MFA prompts fail, enterprise directory sync breaks.",
    ...
    troubleshootingSteps: [
      "Check status.pingidentity.com for platform alerts.",
      "Inspect SAML / OIDC assertion claims and certificates in PingFederate admin console.",
      "Test fallback authentication method.",
      "Check network firewall rules between Ping server and enterprise LDAP.",
    ],
  ...
  },
  {
    ...
    description:
      "Privileged access management (PAM) and identity security platform for enterprise secrets.",
    impactSummary:
      "Privileged session recording drops, password checkouts fail, credential rotation jobs timeout.",
    keyComponents: [
    ...
    troubleshootingSteps: [
      "Check status.cyberark.com for cloud tenant availability.",
      "Verify Secure Tunnel / Connector connectivity to enterprise data center.",
      "Review Safe permissions for target service account.",
      "Contact CyberArk enterprise support.",
    ],
  ...
  },
  {
    ...
    description:
      "Distributed SQL database designed for real-time analytics, transactional workloads, and vector search.",
    impactSummary:
      "Workspace queries timeout, data pipelines lag in ingestion, Helios management API returns 500.",
    keyComponents: [
      "Distributed Aggregator Fleet",
      "Leaf Node Storage Units",
      "Pipelines Ingestion",
      "Helios Cloud API",
    ],
    commonErrorCodes: [
    ...
    troubleshootingSteps: [
      "Check status.singlestore.com for cloud cluster issues.",
      "Verify cluster memory and CPU utilization in Helios portal.",
      "Optimize long-running queries using EXPLAIN.",
      "Check connection pool limits and client timeouts.",
    ],
  ...
  },
  {
    ...
    description:
      "Multi-model database for web applications integrating document, graph, and relational features.",
    impactSummary:
      "SurrealQL queries fail, live query WebSockets disconnect, cloud instance provisioning stalls.",
    keyComponents: [
      "SurrealQL Query Engine",
      "Live Queries WebSocket Gateway",
    ...
    troubleshootingSteps: [
      "Check status.surrealdb.com for cloud instances.",
      "Verify SurrealQL syntax and schema definitions.",
      "Reconnect WebSocket client with exponential retry.",
      "Check instance memory and storage in Surreal Cloud dashboard.",
    ],
  ...
  },
  {
    ...
    description:
      "Fully managed NoSQL document database-as-a-service with built-in cache, search, and analytics.",
    impactSummary:
      "N1QL queries slow down, document mutations fail, App Services sync gateways disconnect.",
    keyComponents: [
      "Data Service (Memcached/KV)",
      "Query Service (N1QL)",
    ...
    troubleshootingSteps: [
      "Check status.couchbase.com for Capella regional maintenance.",
      "Review Couchbase SDK timeout settings (kvTimeout, queryTimeout).",
      "Check index definition and query execution plan.",
      "Inspect bucket memory quota in Capella web console.",
    ],
  ...
  },
  {
    ...
    description:
      "Decentralized crypto trading protocol and interface on Ethereum, Base, Arbitrum, and Polygon.",
    impactSummary:
      "Token swaps fail to route, liquidity pools fail to load quotes, Uniswap mobile wallet drops RPC.",
    keyComponents: [
      "Uniswap Web Interface",
      "Auto Router API",
      "Uniswap Subgraph API",
      "Uniswap Wallet Gateway",
    ],
    commonErrorCodes: [
    ...
    troubleshootingSteps: [
      "Check Uniswap status page and official Discord for front-end outages.",
      "Adjust slippage tolerance in swap settings (0.5% - 1.0%).",
      "Switch RPC provider in connected Web3 wallet (MetaMask, Phantom, Rabby).",
      "Use alternative DEX aggregator (1inch, CoW Swap) if interface is down.",
    ],
  ...
  },
  {
    ...
    description:
      "High-performance blockchain supporting fast, scalable crypto transactions and smart contracts.",
    impactSummary:
      "Slot progression halts, transactions fail with blockhash expired, RPC endpoints return 429.",
    keyComponents: [
      "Mainnet Beta Validator Consensus",
      "Public RPC Nodes",
    ...
    troubleshootingSteps: [
      "Check status.solana.com for consensus and cluster performance.",
      "Switch from public RPC to private dedicated node (Helius, QuickNode, Alchemy).",
      "Increase compute unit price (priority fees) on transactions.",
      "Verify latest Solana CLI and web3.js SDK version.",
    ],
  ...
  },
  {
    ...
    description:
      "Decentralized, open-source blockchain with smart contract functionality and Proof of Stake consensus.",
    impactSummary:
      "Gas fee estimation spikes, node sync latency causes transaction delays, smart contract calls timeout.",
    keyComponents: [
    ...
    troubleshootingSteps: [
      "Check beaconcha.in and ethstats.net for consensus finality.",
      "Increase maxPriorityFeePerGas in wallet EIP-1559 gas settings.",
      "Switch node provider (Infura, Alchemy, Ankr, Cloudflare Ethereum Gateway).",
      "Clear pending nonce in wallet settings.",
    ],
  ...
  },
  {
    ...
    description:
      "Scalable Ethereum scaling network offering low gas fees and high transaction throughput.",
    impactSummary:
      "Heimdall/Bor consensus desync causes block lag, bridging from Ethereum stalls, RPC nodes return 504.",
    keyComponents: [
      "Bor Block Producer",
    ...
    troubleshootingSteps: [
      "Check status.polygon.technology for Heimdall and Bor validator state.",
      "Switch RPC endpoint to alternative provider (Alchemy, QuickNode, Ankr).",
      "Verify bridge deposit transaction confirmations on Ethereum mainnet.",
      "Increase gas price to meet minimum network threshold (30 Gwei).",
    ],
  ...
  },
  {
    ...
    impactSummary:
      "Sequencer batch submissions delay, Base bridge deposits take longer to finalize, public RPC throttles.",
    keyComponents: [
      "OP Stack Sequencer",
      "L1 Batch Submitter",
      "Base Public RPC",
    ...
    troubleshootingSteps: [
      "Check status.base.org for sequencer and bridge status.",
      "Switch wallet RPC URL to private endpoint from Alchemy or QuickNode.",
      "Check Etherscan L1 rollup batch verification status.",
      "Verify wallet chain ID is set to 8453.",
    ],
  ...
  },
  {
    ...
    description:
      "Leading Ethereum Layer 2 optimistic rollup scaling technology with low fees and high throughput.",
    impactSummary:
      "Sequencer feeds experience downtime, gas estimation surges, nitro validator assertions delay.",
    keyComponents: [
      "Nitro Sequencer",
    ...
    troubleshootingSteps: [
      "Check status.arbitrum.io for sequencer maintenance or outage alerts.",
      "Use secondary RPC endpoints (Infura / Alchemy / Chainstack).",
      "Check 7-day challenge period status for native bridge withdrawals.",
      "Verify wallet chain ID is set to 42161.",
    ],
  ...
  },
  {
    ...
    description:
      "Fast, stable, and scalable L2 blockchain built by Ethereum developers, for Ethereum developers.",
    impactSummary:
      "Transactions fail to confirm via sequencer, OP token claim portals fail, Superchain bridge lags.",
    keyComponents: [
      "OP Sequencer Node",
      "Fault Proof System",
      "Superchain Interop Hub",
      "Optimism Gateway RPC",
    ],
    commonErrorCodes: [
      "500 Internal Server Error",
      "429 Rate Limit Exceeded",
      "503 Unavailable",
      "Batch submission delayed",
    ],
    troubleshootingSteps: [
      "Check status.optimism.io for Superchain and OP Mainnet status.",
      "Switch RPC URL to a high-availability node provider.",
      "Verify wallet network configuration (Chain ID: 10).",
      "Check L1 gas prices affecting L2 submission batches.",
    ],
  ...
  },
  {
    ...
    description:
      "Smart contracts platform built to scale infinitely and finalize transactions in under a second.",
    impactSummary:
      "C-Chain block production stalls, Snowman consensus stops finalizing, Avalanche Bridge locks assets.",
    keyComponents: [
      "C-Chain (EVM Execution)",
      "X-Chain (Asset Exchange)",
      "P-Chain (Platform/Subnets)",
    ...
    troubleshootingSteps: [
      "Check status.avax.network for subnet and primary network status.",
      "Switch C-Chain RPC endpoint in Web3 wallet (e.g. Chainstack / QuickNode).",
      "Verify wallet configuration (Chain ID: 43114).",
      "Check Avalanche Bridge explorer for transaction validation.",
    ],
  ...
  },
  {
    ...
    description:
      "Layer-one blockchain designed as a community-run cloud computing platform that eliminates limitations.",
    impactSummary:
      "Nightshade sharding sync errors, FastAuth wallet logins fail, RPC archival queries time out.",
    keyComponents: [
      "Nightshade Sharded Engine",
      "FastAuth & Account Aggregation",
      "NEAR RPC Archival Nodes",
      "Rainbow Bridge",
    ],
    commonErrorCodes: [
      "Server error: -32000",
    ...
    troubleshootingSteps: [
      "Check status.near.org for sharding and validator network status.",
      "Switch to alternative NEAR RPC provider (FastNEAR, Pagoda, Lava).",
      "Verify NEAR account public key and access key permissions.",
      "Check transaction status on NearBlocks explorer.",
    ],
  ...
  },
  {
    ...
    description:
      "Object-centric Layer 1 blockchain powered by the Move programming language for high throughput.",
    impactSummary:
      "Mysticeti consensus stalls, zkLogin authentication fails, Fullnode RPC requests time out.",
    keyComponents: [
      "Mysticeti Consensus Engine",
      "zkLogin Authentication",
      "Fullnode JSON-RPC",
      "SuiVision Explorer API",
    ],
    commonErrorCodes: [
      "-32000 RPC Error",
      "500 Internal Server Error",
    ...
    troubleshootingSteps: [
      "Check status.sui.io for validator checkpoint progress.",
      "Switch Fullnode RPC endpoint to partner nodes (Chainstack, Blockdaemon).",
      "Verify Move package bytecode and gas budget.",
      "Check Sui wallet connection and transaction signatures.",
    ],
